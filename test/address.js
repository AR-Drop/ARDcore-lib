...
var ARDcore = require('..');
var PublicKey = ARDcore.PublicKey;
var Address = ARDcore.Address;
var Script = ARDcore.Script;
var Networks = ARDcore.Networks;

var validbase58 = require('./data/ARDd/base58_keys_valid.json');
var invalidbase58 = require('./data/ARDd/base58_keys_invalid.json');
...
describe('Address', function() {
  ...
  var str = 'AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca';
  ...
  describe('ARDd compliance', function() {
  ...
  // livenet valid
  var PKHLivenet = [
    'AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca',
    'Ac4oWnPgjJa8VyqFYywBo*VZx2QU6EKCDW',
    'AHHUytbocoe8HA4sRJpLcm6NetHFuTwdmi',
    'AbzkXhmXmZ9qZE215cv3ommjjhGbtAzL9i',
    '    AZuRvvyzf1DUzofs12jhh3c12c8Q1c9unC   \t\n'
  ];
  ...
  describe('validation', function() {
    ...
    it('addresses with whitespace are validated correctly', function() {
      ...
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should error because of unrecognized data format', function() {
      ...
      }).should.throw(ARDcore.errors.InvalidArgument);
    });
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca');
    });
    ...
    describe('from a script', function() {
      ...
      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca';
  ...
  describe('#toBuffer', function() {
    ...
    it('ef8f3e801046d34fe00dde3bd33df6f887c6c327 corresponds to hash AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca', function() {
      var address = new Address(str);
  ...
  describe('#object', function() {
    ...
    it('will fail with invalid state', function() {
      ...
      }).to.throw(ARDcore.errors.InvalidState);
    });
  });
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: AUfBpmNE5K2pSY49GyqNRuz42QoDaZzvca, type: pubkeyhash, network: livenet>';
