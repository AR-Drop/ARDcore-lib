...
var BufferWriter = ARDcore.encoding.BufferWriter;
var Opcode = ARDcore.Opcode;
var _ = require('lodash');

var script_valid = require('../data/ARDd/script_valid');
var script_invalid = require('../data/ARDd/script_invalid');
var tx_valid = require('../data/ARDd/tx_valid');
var tx_invalid = require('../data/ARDd/tx_invalid');

//the script string format used in ARDd data tests
Script.fromARDdString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromARDdString(vector[0]);
    var scriptPubkey = Script.fromARDdString(vector[1]);
  ...
  describe('ARDd script evaluation fixtures', function() {
  ...
  describe('ARDd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //ARDd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromARDdString(scriptPubKeyStr);
          });
