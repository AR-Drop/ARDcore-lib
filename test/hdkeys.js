...
var HDPrivateKey = ARDcore.HDPrivateKey;
var HDPublicKey = ARDcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = ARDcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(ARDcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(ARDcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      ARDcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = ARDcore.PublicKey.fromPoint;
      ARDcore.PublicKey.fromPoint = function() {
        ARDcore.PublicKey.fromPoint = unstubbed;
