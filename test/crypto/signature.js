...
var JSUtil = ARDcore.util.js;
var Interpreter = ARDcore.Script.Interpreter;

var sig_canonical = require('../data/ARDd/sig_canonical');
var sig_noncanonical = require('../data/ARDd/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('ARDd fixtures', function() {
