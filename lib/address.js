...
/**
 * Internal function to transform a ARD address buffer
 *
 * @param {Buffer} buffer - An instance of a hex encoded address Buffer
 ...
 *
 * The addresses will be sorted lexicographically, as that is the trend in ARD.
...
/**
 * Internal function to transform a ARD address string
 *
 * @param {string} data
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type: 'pubkeyhash' or 'scripthash'
 ...
 *
 * @param {string} str - An string of the ARD address
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type of address: 'script' or 'pubkey'
 * @returns {Address} A new valid and frozen instance of an Address
 */
 ...
 * var error = Address.getValidationError('', 'testnet');
 * ```
 *
 ...
 *
 * @returns {Buffer} ARD address buffer
 */
