...
/**
 * A ARD transaction script. Each transaction's inputs and outputs
...
/**
 * Analogous to ARDd's FindAndDelete. Find and delete equivalent chunks,
...
/**
 * Comes from ARDd's script interpreter CheckMinimalPush function
...
/**
 * Comes from ARDd's script DecodeOP_N function
 * @param {number} opcode
...
/**
 * Comes from ARDd's script GetSigOpCount(boolean) function
